...
const SvgPartlyCloudyDayRain = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" {...props}>
    <defs>
      <clipPath id="partly-cloudy-day-rain_svg__a">
        <path
          fill="none"
    ...
    <g clipPath="url(#partly-cloudy-day-rain_svg__a)">
      <path
        fill="none"
        stroke="#f59e0b"
        strokeLinecap="round"
...
export default SvgPartlyCloudyDayRain;
