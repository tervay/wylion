...
const SvgThunderstormsNightSnow = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" {...props}>
    <defs>
      <clipPath id="thunderstorms-night-snow_svg__a">
        <path
          fill="none"
    ...
    <g clipPath="url(#thunderstorms-night-snow_svg__a)">
      <path
        fill="none"
        stroke="#72b9d5"
        strokeLinecap="round"
...
export default SvgThunderstormsNightSnow;
